...
namespace ADSCloud.Views
{
    public partial class Generate_report_tf : Form
    {
        ...
        private void caldisso_Click(object sender, EventArgs e)
        {
            ...
            if (_totalsample > 1 && (Labelamount.Text == "" || dissovolume.Text == "" || labelamtapI2.Text == "" || dissolvolone.Text == ""))
            {
                MessageBox.Show("Enter all the values!");
                
            }
            else if (_totalsample == 1 && (Labelamount.Text == "" || dissovolume.Text == ""))
            {
                MessageBox.Show("Enter all the values!");
            }
            else
                    ...
                    if (_totalsample > 1)
                    {
                        ...
                        for (int i = 0; i < dataGridView1.RowCount - 1; i++)
                        {
                            if (i < _totalsamples)
                            {
                                ...
                                _perdissolution = (_sampleconcentration * double.Parse(dissovolume.Text) / double.Parse(Labelamount.Text))*100;
                            }
                            else
                            {
                                _sampleconcentration = double.Parse(factorapitwo.Text) * double.Parse(dataGridView1.Rows[i].Cells[2].Value.ToString());
                                _perdissolution = (_sampleconcentration * double.Parse(dissolvolone.Text) / double.Parse(labelamtapI2.Text))*100;
                            }
        ...
        private void _chartproperties()
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= _countsample; i++)
                {
                    if (i <= int.Parse(Nsamples_txt.Text))
                    {
                        if (chart1.Series.IsUniqueName("Vessel " + i))
                        {
                            chart1.Series.Add("Vessel " + i);
                            chart1.Series["Vessel " + i].ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Spline;
                            chart1.Series["Vessel " + i].MarkerStyle = MarkerStyle.Square;
                            chart1.Series["Vessel " + i].MarkerSize = 5;
                            chart1.Series["Vessel " + i]["LineTension"] = "0.1";
                            chart1.Series["Vessel " + i].ToolTip = "Y = #VALY\nX = #VALX";
                        }
                ...
                if (_totalsample > 1)
                {
                    for (i = 0; i < dataGridView1.Rows.Count - int.Parse(Nsamples_txt.Text); i = i + int.Parse(Nsamples_txt.Text))
                    {
                        if (i < _totalsamples || _totalsample < 1)
                        {
                            ...
                            while (j % int.Parse(Nsamples_txt.Text) != 0)
                            {  
                                chart1.Series["Vessel " + j].Points.AddXY(dataGridView1.Rows[i + (j - 1)].Cells[1].Value.ToString(), dataGridView1.Rows[i + (j - 1)].Cells[3].Value.ToString());
                                j++;
                            }
                            chart1.Series["Vessel " + j].Points.AddXY(dataGridView1.Rows[j - 1].Cells[1].Value.ToString(), dataGridView1.Rows[i + (j - 1)].Cells[3].Value.ToString());
                        ...
                        else
                        {
                            ...
                            while (j % int.Parse(Nsamples_txt.Text) != 0)
                            {
                                chart2.Series["Vessel " + j].Points.AddXY(dataGridView1.Rows[i + (j - 1)].Cells[1].Value.ToString(), dataGridView1.Rows[i + (j - 1)].Cells[3].Value.ToString());
                                j++;
                            }
                            chart2.Series["Vessel " + j].Points.AddXY(dataGridView1.Rows[j - 1].Cells[1].Value.ToString(), dataGridView1.Rows[i + (j - 1)].Cells[3].Value.ToString());
                            //i = i + int.Parse(Nsamples_txt.Text);
                            j = 1;
                        }
                    }
        ...
        private void Sbutton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_totalsample == 1)
                {
                    ...
                    para_Factor.Add("Dissolution Volume : " + dissolvolone.Text + " mL");
                ...
                else
                {
                    ...
                    para_Factor.TabSettings = new TabSettings(300);
                    para_Factor.Add(Chunk.TABBING);
                    para_Factor.Add("Dissolution Volume : " + dissolvolone.Text + " , " + dissovolume.Text + " mL");
                }
